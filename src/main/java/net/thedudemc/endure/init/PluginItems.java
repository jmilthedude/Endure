...
public class PluginItems {
    ...
    public static void register() {
        DINKY_SWORD = registerItem(new WeaponItem("dinky_sword", "Dinky Sword", Material.WOODEN_SWORD, Rarity.COMMON)
                .withAttribute(PluginAttributes.BONUS_DAMAGE,
                        new EndureModifier(
                                PluginAttributes.BONUS_DAMAGE.getDisplayName(),
                                12.0D, AttributeModifier.Operation.ADD_NUMBER))
                .withAttribute(PluginAttributes.BASE_DAMAGE,
                        new EndureModifier(
                                PluginAttributes.BASE_DAMAGE.getDisplayName(),
        ...
        EMPTY_BOTTLE = registerItem(new EndureItem("empty_bottle", "Empty Bottle", Material.GLASS_BOTTLE))
                .withAttribute(PluginAttributes.MAX_STACK_SIZE,
                        new EndureModifier(
                                PluginAttributes.MAX_STACK_SIZE.getDisplayName(),
                                2.0D, AttributeModifier.Operation.ADD_NUMBER)
                );
